...
def main():
    """Test the tracking service with a sample video."""
    ...
    try:
        ...
        # Run tracking - This was previously failing due to None confidence values
        print("Running tracking...")
        tracks = tracking_service.update_tracks(detections, frame)
